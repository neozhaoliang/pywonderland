...
class Automaton:
    ...
    reachable from the start will automatically be assigned a number.

    The advantage of this approach of representing an automaton is that all the "dead states"
