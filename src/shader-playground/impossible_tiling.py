...
class Escher(pyglet.window.Window):
    ...
    def __init__(self, width, height):
        ...
        self.shader = Shader(["./glsl/default.vert"],
                             ["./glsl/impossilbe_tiling/impossible_tiling.frag"])
        self.init_shader()
    ...
    def on_draw(self):
        ...
        with self.shader:
            ...
            self.shader.uniformf("iTime", dt * 12)
    ...
    def save_screenshot(self):
        pyglet.image.get_buffer_manager().get_color_buffer().save("impossible-tiling.png")
