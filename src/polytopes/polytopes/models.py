...
class BasePolytope(object):
    ...
    def __init__(self, coxeter_diagram, init_dist, extra_relations=()):
        ...
        :param extra_relations: a presentation of a star polytope can be
            ...
            For example "(ρ₀ρ₁ρ₂ρ₁)^n = 1" for some integer n, where n is the
    ...
    def get_edges(self):
        ...
        If the initial vertex v₀ lies on the i-th mirror then the reflection
        about this mirror fixes v₀ and there are no edges of type i. Else v₀
        and its virtual image v₁ about this mirror generate a base edge e, the
        stabilizing subgroup of e is generated by the simple reflection ρᵢ plus
        those simple reflections ρⱼ such that ρⱼ fixes v₀ and commutes with ρᵢ:
        ρᵢρⱼ=ρⱼρᵢ. Again we use Todd-Coxeter's procedure to get a complete list
    ...
    def get_faces(self):
        ...
        by {ρᵢ, ρⱼ} plus those simple reflections ρₖ such that ρₖ fixes the
        initial vertex v₀ and commutes with both ρᵢ and ρⱼ.
        """
        for i, j in combinations(self.symmetry_gens, 2):
...
class Snub24Cell(Polychora):
    ...
    def get_faces(self):
        ...
        r₁r₂ = r₃, where r₁, r₂, r₃ are three fundamental rotations.
        """
        for rot in ((0,), (2,), (4,)):
