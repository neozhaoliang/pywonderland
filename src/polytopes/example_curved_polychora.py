...
def main():
    draw((3, 2, 2, 3, 2, 3), (1, 0, 0, 0), description="5-cell",
         camera_loc=(0, 0, 120), vertex_size=0.08, rotation=(-30, 60, 0),
         edge_size=0.04, size_func=1)

    draw((4, 2, 2, 3, 2, 3), (1, 0, 0, 0), description="4d-cube",
         camera_loc=(0, 0, 130), vertex_size=0.06, rotation=(60, 0, 0),
         edge_size=0.03, size_func=1, face_min=0.2, face_max=0.8)

    draw((3, 2, 2, 3, 2, 4), (1, 0, 0, 0), description="16-cell",
         camera_loc=(0, 0, 160), vertex_size=0.08,
         edge_size=0.03, size_func=2, face_min=1.0, face_max=1.2)

    draw((3, 2, 2, 4, 2, 3), (1, 0, 0, 0), description="24-cell",
         camera_loc=(0, 0, 200), vertex_size=0.06,
         edge_size=0.04, size_func=2, face_min=0.2, face_max=0.8)

    draw((5, 2, 2, 3, 2, 3), (1, 0, 0, 0), description="120-cell",
         camera_loc=(0, 0, 400), vertex_size=0.05,
         edge_size=0.025, size_func=0, face_min=3.0, face_max=100.0)

    draw((3, 2, 2, 3, 2, 5), (1, 0, 0, 0), description="600-cell",
         bg_color="White", camera_loc=(0, 0, 500), vertex_size=0.12,
         edge_size=0.04, size_func=2, face_max=4.0, face_min=3.0)

    draw((3, 2, 2, 3, 2, 4), (1, 0, 0, 1), description="runcinated-16-cell",
         bg_color="White", camera_loc=(0, 0, 450), vertex_size=0.1,
         face_index=(0, 1, 2, 3), edge_size=0.04, size_func=1,
         face_min=0, face_max=3)
